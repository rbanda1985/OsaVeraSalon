...
const Navbar = () => {
  ...
  return(
    <>
      <MDBNavbar expand='lg' light bgColor='dark' className='navigation-bar'>
      <MDBContainer fluid>
        <MDBNavbarToggler
          type='button'
        ...
        <MDBCollapse navbar show={showNavCentred} center id='navbarCenteredExample'>
          <MDBNavbarNav fullWidth={false} className='mb-2 mb-lg-0'>
            ...
            <MDBNavbarItem>
              <MDBNavbarLink href='#'>
              <span className='navigation-link'>Policies</span>
                </MDBNavbarLink>
            </MDBNavbarItem>
            <MDBNavbarItem>
              <MDBNavbarLink href='#'>
            ...
            <MDBNavbarItem>
              <MDBNavbarLink href='#'>
              <span className='navigation-link'>Gallery</span>
                </MDBNavbarLink>
            </MDBNavbarItem>
          </MDBNavbarNav>
        </MDBCollapse>
